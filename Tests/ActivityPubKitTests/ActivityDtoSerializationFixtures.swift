...
enum ActivityDtoSerializationFixtures {
...
"""
    ...
    static func createFollowActivityDto() -> ActivityDto {
        ActivityDto(
...
"""
    ...
    static let expectedAnnouncementId = "https://pixelfed.social/p/mczachurski/624586708985817828/activity"
    static let expectedAnnouncementActor = "https://pixelfed.social/users/mczachurski"
    static let expectedAnnouncementObjectId = "https://mastodonapp.uk/@damianward/111322877716364793"
}
