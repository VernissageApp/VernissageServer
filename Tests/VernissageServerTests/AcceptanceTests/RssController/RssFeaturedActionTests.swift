...
extension ControllersTests {
    ...
    struct RssFeaturedActionTests {
        ...
        @Test
        func `Rss feed with featured public statuses should be returned`() async throws {
            // Arrange.
        ...
        @Test
        func `Rss feed with featured public statuses should not be returned when public access is disabled`() async throws {
            // Arrange.
