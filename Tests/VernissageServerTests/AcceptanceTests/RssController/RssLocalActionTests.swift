...
extension ControllersTests {
    ...
    @Suite("Rss (GET /rss/local", .serialized, .tags(.rss))
    struct RssLocalActionTests {
        ...
        @Test
        func `Rss feed with local public statuses should be returned`() async throws {
        ...
        @Test
        func `Rss feed with local public statuses should not be returned when public access is disabled`() async throws {
            // Arrange.
