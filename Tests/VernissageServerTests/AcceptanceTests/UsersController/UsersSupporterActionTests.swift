...
extension ControllersTests {
    ...
    struct UsersSupporterActionTests {
        ...
        @Test
        func `User should be mark as supporter for authorized user`() async throws {
        ...
        @Test
        func `User should not be mark as supporter for regular user`() async throws {
        ...
        @Test
        func `Mark as supporter should return not found for not existing user`() async throws {
        ...
        @Test
        func `Mark as supporter should return unauthorized for not authorized user`() async throws {
