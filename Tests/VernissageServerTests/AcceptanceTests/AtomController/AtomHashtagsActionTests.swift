...
extension ControllersTests {
    ...
    struct AtomHashtagsActionTests {
        ...
        @Test
        func `Atom feed with hashtags public statuses should be returned`() async throws {
        ...
        @Test
        func `Atom feed with hashtags public statuses should not be returned for not existing hashtag`() async throws {
        ...
        @Test
        func `Atom feed with hashtags public statuses should not be returned when public access is disabled`() async throws {
            // Arrange.
